...
public class PlayerCardClickListener implements View.OnClickListener {
    ...
    final ClientGameController clientGameController = ClientGameController.getInstance();
    final Player me;          // the player who clicked the cardr
    final Player card;        // the card clicked on
